public class Messages {
    ...
    public static String updatedCampaign= "Kampanya Başarıyla Güncellendi.";
    ...
    public static String validationUserSuccess= "Doğrulama Başarılı.";
    public static String validationUserUnSuccess= "Doğrulama Başarısız";
    public static String firstName= "Adı: ";
    public static String lastName= "Soyadı: ";
    ...
    public static String sellFullName="Satan: ";
    public static String sellGameName="Oyun Adı: ";
    public static String sellGamePrice="Fiyatı: ";
    public static String sellPriceType=" TL";
