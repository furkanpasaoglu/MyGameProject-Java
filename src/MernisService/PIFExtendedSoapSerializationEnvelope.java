...
public class PIFExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(PIFDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new PIFStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static PIFDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static PIFDateTimeConverter dateTimeConverter = new PIFStandardDateTimeConverter();

    public PIFExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public PIFExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new PIFMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=PIFHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,PIFExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=PIFHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
