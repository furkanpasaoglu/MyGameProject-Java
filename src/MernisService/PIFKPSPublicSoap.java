...
public class PIFKPSPublicSoap
{
    ...
    public PIFKPSPublicSoap(){}

    public PIFKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public PIFKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        PIFExtendedSoapSerializationEnvelope envelope= new PIFExtendedSoapSerializationEnvelope(PIFExtendedSoapSerializationEnvelope.VER11);
